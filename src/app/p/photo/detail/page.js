                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div className="bg-black flex justify-center items-center relative">
                            ...
                            <img
                                src={photo.image_url}
                                alt={photo.nama}
                                className={`object-cover w-full h-full max-h-[300px] md:max-h-none transition-opacity duration-500 ${isImageLoaded ? "opacity-100" : "opacity-0"}`}
                        ...
                        <div className="flex flex-col">
                            <div className="p-4 border-b border-pink-100 flex justify-between">
                                <h1 className="text-pink-500 font-semibold text-xl">{photo.nama}</h1>
                                <button onClick={handleShareLink} className="text-gray-500 hover:text-pink-500 transition">
                                    <i className="fa-solid fa-share-nodes text-2xl"></i>
                                </button>
                            </div>
                            <div className="p-4">
                                <p className="text-gray-500">{photo.deskripsi}</p>
                            </div>
                        </div>
                    </div>
                </div>
